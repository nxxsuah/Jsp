	...
	<body>
		...
		<!-- 
			request 내장 객체
		 	...
		 	GET 요청
		 	 - 기본 링크 페이지 요청
		 	 - 데이터 전송은 주소 뒤에 ? 파라미터 문자열(Query String)로 전송
		 	 - 보안에 취약하지만 빠른 요청처리
			
			POST 요청
			 - 폼 전송 데이터 요청
			 - 전송 데이터가 요청 객체 body에 저장되어 전송(편지봉투 넣어서)
			 - 전송 데이터 보안에 유리하고 대량의 데이터 전송에 적합 	
		 -->
		
		<h4>GET 요청 : page 주세요</h4>
		...
		<form action = "./proc/result3.jsp"> <!-- form method 속성이 없으면 GET 요청가능 -->
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    <td>숨긴필드</td>
                    <td> 
                        <input type="hidden" name="id" value="nxxsuah"/>
                     </td>
                </tr>
                <tr>
